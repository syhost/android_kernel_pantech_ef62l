...
#endif
{
  ...
  //lock_kernel(); //ioctl -> unlocked_ioctl �� �����Ǿ� �߰�
  ...
  switch(cmd)
  {
    ...
    case IOCTL_TDMB_BB_READ_MSC: // tdmb_read �� ��ü
...
irqreturn_t tdmb_interrupt(int irq, void *dev_id)
{
  ...
  if ((play_start == 1) && (irq == gpio_to_irq(DMB_INT))) // play �� DMB_INT ���� ����ó��
  {
...
#ifndef FEATURE_TS_PKT_MSG
  if(g_tdmb_interrupt_cnt >= 100) // get_ber �� ���� �ʴ� ���츦 ����, ������ �������� ���ͷ�Ʈ�� �ߴ��� �޽����� ������.
  {
